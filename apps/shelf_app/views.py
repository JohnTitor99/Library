...
class FinishedCreate(generic.CreateView):
    model = Finished
    fields = ['name']
    template_name = 'shelf_app/finished_create.html'
    ...
    def form_valid(self, form):
        ...
        return super(FinishedCreate, self).form_valid(form)
...
# class FinishedDelete(generic.DeleteView):
#     model = Finished
#     context_object_name = 'finished'
#     template_name = 'shelf_app/finished_confirm_delete.html'
...
class FinishedUpdate(generic.UpdateView):
    model = Finished
    fields = ['name']
    template_name = 'shelf_app/finished_update.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['finished_list'] = context['finished_list'].filter(library__name=self.kwargs.get('lib_name'))
        context['lib_name'] = self.kwargs.get('lib_name')
        context['finished_update'] = self.kwargs.get('pk')
        return context
